...
from verl.trainer.ppo.core_algos import agg_loss, compute_policy_loss, kl_penalty, compute_policy_loss_vanilla
        ...
        for epoch in range(self.config.ppo_epochs):
            for batch_idx, data in enumerate(dataloader):
                ...
                for data in micro_batches:
                    ...
                    if self.config.policy_loss == 'plusplus':
                    ...
                    elif self.config.policy_loss == 'vanilla':
                        ...
                        raise ValueError(f"Unsupported policy loss type: {self.config.policy_loss}")
